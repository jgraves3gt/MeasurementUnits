...
namespace MeasurementUnits.Units.Volume
{
    ...
    public class L : IVolume
    {
        ...
        public static L FromVolumeUnit<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new L();
        ...
        public static L ConvertFrom<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new L();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static L ConvertFrom(VolumeUnits unit, double value)
        {
            switch (unit)
            {
                default:
