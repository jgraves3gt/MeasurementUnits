...
namespace MeasurementUnits.Units.Volume
{
    ...
    public class cl : IVolume
    {
        ...
        public static cl FromVolumeUnit<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new cl();
        ...
        public static cl ConvertFrom<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new cl();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static cl ConvertFrom(VolumeUnits unit, double value)
        {
            switch (unit)
            {
                default:
