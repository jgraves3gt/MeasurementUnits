...
namespace MeasurementUnits.Units.Mass
{
    ...
    /// Ounces
    /// </summary>
    public class oz : IMass
    {
        public double Value { get; set; }

        public double BaseReference { get { return 28349.5; } }
        ...
        public static oz FromMassUnit<TMass>(TMass source) where TMass : IMass
        {
            var result = new oz();
        ...
        public static oz ConvertFrom<TMass>(TMass source) where TMass : IMass
        {
            var result = new oz();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static oz ConvertFrom(MassUnits unit, double value)
        {
            switch (unit)
            {
                default:
