...
namespace MeasurementUnits.Units.Mass
{
    ...
    public class dg : IMass
    {
        ...
        public static dg FromMassUnit<TMass>(TMass source) where TMass : IMass
        {
            var result = new dg();
        ...
        public static dg ConvertFrom<TMass>(TMass source) where TMass : IMass
        {
            var result = new dg();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static dg ConvertFrom(MassUnits unit, double value)
        {
            switch (unit)
            {
                default:
