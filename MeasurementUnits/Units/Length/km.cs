...
namespace MeasurementUnits.Units.Length
{
    ...
    public class km : ILength
    {
        ...
        public static km FromLengthUnit<TLength>(TLength source) where TLength : ILength
        {
            var result = new km();
        ...
        public static km ConvertFrom<TLength>(TLength source) where TLength : ILength
        {
            var result = new km();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static km ConvertFrom(LengthUnits unit, double value)
        {
            switch (unit)
            {
                default:
