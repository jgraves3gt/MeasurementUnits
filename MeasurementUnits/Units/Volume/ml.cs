...
namespace MeasurementUnits.Units.Volume
{
    ...
    public class ml : IVolume
    {
        ...
        public static ml FromVolumeUnit<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new ml();
        ...
        public static ml ConvertFrom<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new ml();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static ml ConvertFrom(VolumeUnits unit, double value)
        {
            switch (unit)
            {
                default:
