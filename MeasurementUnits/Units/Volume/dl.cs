...
namespace MeasurementUnits.Units.Volume
{
    ...
    public class dl : IVolume
    {
        ...
        public static dl FromVolumeUnit<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new dl();
        ...
        public static dl ConvertFrom<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new dl();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static dl ConvertFrom(VolumeUnits unit, double value)
        {
            switch (unit)
            {
                default:
