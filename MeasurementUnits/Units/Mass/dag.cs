...
namespace MeasurementUnits.Units.Mass
{
    ...
    public class dag : IMass
    {
        ...
        public static dag FromMassUnit<TMass>(TMass source) where TMass : IMass
        {
            var result = new dag();
        ...
        public static dag ConvertFrom<TMass>(TMass source) where TMass : IMass
        {
            var result = new dag();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static dag ConvertFrom(MassUnits unit, double value)
        {
            switch (unit)
            {
                default:
