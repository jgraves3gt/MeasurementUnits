...
namespace MeasurementUnits.Units.Mass
{
    ...
    public class hg : IMass
    {
        ...
        public static hg FromMassUnit<TMass>(TMass source) where TMass : IMass
        {
            var result = new hg();
        ...
        public static hg ConvertFrom<TMass>(TMass source) where TMass : IMass
        {
            var result = new hg();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static hg ConvertFrom(MassUnits unit, double value)
        {
            switch (unit)
            {
                default:
