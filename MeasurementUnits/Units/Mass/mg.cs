...
namespace MeasurementUnits.Units.Mass
{
    ...
    public class mg : IMass
    {
        ...
        public static mg FromMassUnit<TMass>(TMass source) where TMass : IMass
        {
            var result = new mg();
        ...
        public static mg ConvertFrom<TMass>(TMass source) where TMass : IMass
        {
            var result = new mg();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static mg ConvertFrom(MassUnits unit, double value)
        {
            switch (unit)
            {
                default:
