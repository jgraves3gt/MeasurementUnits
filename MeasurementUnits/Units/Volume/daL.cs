...
namespace MeasurementUnits.Units.Volume
{
    ...
    public class daL : IVolume
    {
        ...
        public static daL FromVolumeUnit<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new daL();
        ...
        public static daL ConvertFrom<TVolume>(TVolume source) where TVolume : IVolume
        {
            var result = new daL();
            var baseValue = source.Value * source.BaseReference;
            result.Value = baseValue / result.BaseReference;
        ...
        public static daL ConvertFrom(VolumeUnits unit, double value)
        {
            switch (unit)
            {
                default:
